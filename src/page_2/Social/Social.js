    ...
    return (
      ...
      <div className="mt-4">
        <button
          ...
          className='btn btn-outline btn-success w-50 mx-auto d-block p-2 fs-4 mb-4 '>Google Sign In</button>
        <button

          onClick={() => signInWithGithub()}
          className='btn btn-outline btn-warning w-50 mx-auto d-block mb-4 p-2 fs-4'>Github Sign In</button>
      </div>
    </div>
    );
};
